...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './UltraMax.db' : process.env.DATABASE_URL;
DEBUG = process.env.DEBUG === undefined ? false : convertToBool(process.env.DEBUG);

module.exports = {
    VERSION: 'Ultra Max 3.0.0v - Public Stable',
    SESSION: process.env.Max_SESSION === undefined ? '' : process.env.Max_SESSION,
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/87f5631e2d5108f51f557.png' : process.env.ALIVE_LOGO,
    WELCOME_LOGO: process.env.WELCOME_LOGO === undefined ? 'https://telegra.ph/file/3ed30d6d6edb6c074a1a1.mp4' : process.env.WELCOME_LOGO,
    BYE_LOGO: process.env.BYE_LOGO === undefined ? 'https://telegra.ph/file/3f98e3719e62cf5335fa4.jpg' : process.env.BYE_LOGO,
    ...
    DATABASE: DATABASE_URL === './UltraMax.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
    ...
    MaxNIWASA: "393475528094-1415817281",
