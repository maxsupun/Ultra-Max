...
global.alivemsg = `📤I am alive now😇 My Creators :- Max Supun , RishBroProamax
...
//owner v card
global.vcardowner = ['your number'] // owner number
global.ownername = "𝕸𝖆𝖝 𝕾𝖚𝖕𝖚𝖓 " // owner name
global.ytname = "" // yt chanel name
global.socialm = "GitHub: maxsupun" // github or insta name
global.location = "Sri Lanka" // location

//bot body 
global.alivepic = `𝔾𝕚𝕧𝕖 𝕐𝕠𝕦𝕣 𝕋𝕖𝕜𝕖𝕘𝕣𝕒𝕡𝕙 𝕃𝕚𝕟𝕜` // alive picture \\ use "https://ibb.com" to upload photos. < 1 MB
...
global.owner = ['𝚈𝚘𝚞𝚛 𝙽𝚞𝚖𝚋𝚎𝚛 '] // 𝔾𝕦𝕧𝕚 𝕐𝕠𝕦𝕣 ℕ𝕦𝕞𝕓𝕖𝕣 
global.ownertag = '𝚈𝚘𝚞𝚛 𝙽𝚞𝚖𝚋𝚎𝚛' //your tag number
global.botname = '𝚄𝚕𝚝𝚛𝚊 𝙼𝚊𝚡 𝙱𝚘𝚝' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "𝚄𝚕𝚝𝚛𝚊 𝙼𝚊𝚡 𝙱𝚘𝚝" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ ◉ 𝚄𝚕𝚝𝚛𝚊 𝙼𝚊𝚡 𝙱𝚘𝚝 ]' //

global.button = '🇱🇰 𝔾𝕚𝕥𝕙𝕦𝕓 🇱🇰' //Costomize A Button Name In Alive Message
global.btnurl = 'https://github.com/𝙼𝚊𝚡𝚂𝚞𝚙𝚞𝚗' //Change Your Button's URL

//database
global.premium = ['Your Number'] //ur premium numbers
...
global.mess = {
    ...
    caption: 'Generated by: ◉ *𝚄𝚕𝚝𝚛𝚊 𝙼𝚊𝚡 𝙱𝚘𝚝*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
...
// Auto Reply Massege Wait I Wan't Add New File...  Max Supun Accpet this 
...
global.rep = { // All Replies = 145
    ...
    K4: '🥴හූයි😊',
    K5: '😂හේයි, හව් ආ යූ🥴✌️',
    K6: '😁Hey there💝 I am WhatsApp Bot. Made By RishbroProMax And Supun Max😏',
    K7: '❣️ඇයි හලෝ😌',
    K8: '🙃මොකෝ හලෝ🥲',
    K9: '😒මොකෝ?',
    K10: '🥺ඇයි අනේ?❤️🫢',
