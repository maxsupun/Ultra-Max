...
Max.applyCMD({pattern: 'term ?(.*)', fromMe: true, desc: Lang.TERM_DESC, dontAddCommandList: true}, (async (message, match) => {    
...
Max.applyCMD({pattern: 'print ?(.*)', fromMe: true, desc: p_desc, dontAddCommandList: true}, (async (message, match) => {    
