...
if (Config.WORKTYPE == 'private') {
    ...
    Max.applyCMD({pattern: 'ocr ?(.*)', fromMe: true, desc: Lang.OCR_DESC,  deleteCommand: false}, (async (message, match) => { 
    ...
    Max.applyCMD({pattern: 'ocr ?(.*)', fromMe: false, desc: Lang.OCR_DESC}, (async (message, match) => { 
