...
const fs = require("fs")
const Max = fs.readFileSync('./media/Maxbot.mp3')  
let LOL = Config.WORKTYPE == 'public' ? false : true

const Language = require('../language');
const Lang = Language.getString('_Max');
const dmenu = "💠📃 ●Ultra Max PANEL● 📃💠\n\n"


Max.applyCMD({pattern: Config.MENU + '?(.*)', fromMe: LOL, dontAddCommandList: true, deleteCommand: false,}, (async (message, match) => {
    ...
    if (match[1] === '') {
        ...
        await message.client.sendMessage(message.jid, Max, MessageType.audio, {mimetype: 'audio/mp4', ptt:true}, {quoted: message.data})
