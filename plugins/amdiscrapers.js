...
Max.applyCMD({ pattern: 'song ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.SONG_DESC}, (async (message, match) => {
...
Max.applyCMD({ pattern: 'video ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.VIDEO_DESC}, (async (message, match) => {
...
Max.applyCMD({pattern: 'yt ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.YT_DESC}, (async (message, match) => { 
...
/*
Max.applyCMD({ pattern: 'fb ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.FBDESC}, (async (message, match) => {

    const userName = match[1]

    if (!userName) return await message.client.sendMessage(message.jid,Lang.NEED_WORD,MessageType.text, {quoted: message.data});

    var payload = await UltraMax.fb(userName)
...
Max.applyCMD({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: LOL}, (async (message, match) => {
...
Max.applyCMD({pattern: 'spdf ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.SPDF_DESC }, (async (message, match) => {
...
Max.applyCMD({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: LOL,  deleteCommand: false, desc: Lang.CURRENCY_DESC}, (async (message, match) => {
...
Max.applyCMD({pattern: 'tts (.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.TTS_DESC}, (async (message, match) => {
...
Max.applyCMD({pattern: 'wiki ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.WIKI_DESC}, (async (message, match) => { 
...
Max.applyCMD({pattern: 'img ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.IMG_DESC}, (async (message, match) => { 
...
Max.applyCMD({pattern: 'quote ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.QUOTE_DESC}, async (message, match) => {
...
Max.applyCMD({pattern: 'wame ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Lang.WAME_DESC}, (async (message, match) => {    
...
Max.applyCMD({ pattern: 'github ?(.*)', fromMe: LOL,  deleteCommand: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {

    const userName = match[1]
 
    if (userName === '') return await message.client.sendMessage(message.jid, Glang.REPLY, MessageType.text, {quoted: message.data})

    var payload = await UltraMax.github(userName)
...
Max.applyCMD({ pattern: 'tk ?(.*)', fromMe: LOL,  deleteCommand: false, desc: TKlang.TK_DESC }, async (message, match) => {

    const userName = match[1]
 
    if (userName === '') return await message.client.sendMessage(message.jid, TKlang.REPLY, MessageType.text, {quoted: message.data})

    var payload = await UltraMax.tiktok_user(userName)
...
Max.applyCMD({ pattern: 'apk ?(.*)', fromMe: LOL, desc: Lang.APK_DESC,  deleteCommand: false}, async (message, match) => {
    ...
    var apk = await UltraMax.apk(link)
    var apkinfo = await UltraMax.apk_info(link)
