...
if (Config.WORKTYPE == 'private') {
    Max.applyCMD({ pattern: 'info', fromMe: true, desc: Lang.INFO_DESC, deleteCommand: false}, async (message, match) => { 
    ...
    Max.applyCMD({ pattern: 'info', fromMe: false, desc: Lang.INFO_DESC}, async (message, match) => { 
