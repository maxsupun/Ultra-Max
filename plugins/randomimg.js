...
Max.applyCMD({pattern: 'bts ?(.*)', fromMe: LOL, desc: Lang.BTS_DESC,  deleteCommand: false}, (async (message, match) => {
...
Max.applyCMD({pattern: 'exo ?(.*)', fromMe: LOL, desc: Lang.EXO_DESC,  deleteCommand: false}, (async (message, match) => {
...
Max.applyCMD({pattern: 'Supunpink ?(.*)', fromMe: LOL, desc: Lang.BP_DESC,  deleteCommand: false}, (async (message, match) => {

    var apikey = await UltraMax.api()

    var webimage = await axios.get('https://api.lolhuman.xyz/api/random/Supunpink?apikey=' + apikey.key, { responseType: 'arraybuffer' })
...
Max.applyCMD({pattern: 'ewallpaper ?(.*)', fromMe: LOL, desc: Lang.BP_DESC,  deleteCommand: false}, (async (message, match) => {

    var webimage = await axios.get(`https://api.zeks.me/api/estetikpic?apikey=maxsupun`, { responseType: 'arraybuffer' })
