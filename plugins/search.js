/*
Ultra Max Bot - A whatsapp user bot.
Copyright (C) 2021 Supun Max
...
Max.applyCMD({ pattern: 'mod ?(.*)', fromMe: LOL, desc: Lang.USAGE,  deleteCommand: false }, async (message, match) => {
...
Max.applyCMD({ pattern: 'getspo ?(.*)', fromMe: LOL, desc: Lang.SPO_USAGE,  deleteCommand: false }, async (message, match) => {
...
Max.applyCMD({ pattern: 'getpack ?(.*)', fromMe: LOL, desc: Lang.APK_DESC,  deleteCommand: false }, async (message, match) => {
...
/* WORKING IN PROGRESS
Max.applyCMD({ pattern: 'getsong ?(.*)', fromMe: LOL, desc: Lang.FIND_DESC,  deleteCommand: false }, async (message, match) => {
