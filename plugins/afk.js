...
Max.applyCMD({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
...
Max.applyCMD({pattern: 'online ?(.*)', fromMe: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
...
Max.applyCMD({pattern: 'afk ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.AFK_DESC, dontAddCommandList: true}, (async (message, match) => {     
    if (!AFK.isAfk) {
